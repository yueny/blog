...
<nav class="navbar navbar-default shadow-box background-white">
    ...
    <div id="home-navbar" class="collapse navbar-collapse">
        <ul class="list-group user-nav first">
            <li class="list-group-item">
                <a href="${base}/users/${user.domainHack}"><i class="icon icon-list"></i> 发表的文章</a>
            </li>
            <li class="list-group-item">
                <a href="${base}/users/${user.domainHack}/comments"><i class="icon icon-speech"></i> 发表的评论</a>
            </li>
            <li class="list-group-item">
                <a href="${base}/users/${user.domainHack}/favorites"><i class="icon icon-heart"></i> 收藏的文章</a>
            </li>
        </ul>
        ...
        <#if owner>
            <ul class="list-group user-nav">
                <li class="list-group-item">
                    <a href="${base}/users/${user.domainHack}/messages">
