 ...
 */
@Service
public class DiamondConfigAbilityServiceImpl implements IConfigAbilityService {
	...
	public static Set<String> getSecurityIpWhite() {
		String val = get(ConfigKeysConstant.SECURITY_IP_WHITE_KEY);
	...
	public static Set<String> getSecurityAttackUrl() {
		String val = get(ConfigKeysConstant.SECURITY_ATTACK_URL_KEY);
		if(StringUtils.isEmpty(val)){
			return Collections.emptySet();
		}
