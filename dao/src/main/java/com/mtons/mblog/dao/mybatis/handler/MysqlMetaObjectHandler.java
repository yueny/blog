...
public class MysqlMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        this.setFieldValByName(MapperConst.CREATE_TIME_FIELD, Calendar.getInstance().getTime(), metaObject);
        this.setFieldValByName(MapperConst.MODIFY_TIME_FIELD, Calendar.getInstance().getTime(), metaObject);
    }
